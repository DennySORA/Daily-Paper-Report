...
## Required Files
- `features/add-int-e2e-harness/E2E_PLAN.md`
- `features/add-int-e2e-harness/ACCEPTANCE.md`
- `features/add-int-e2e-harness/STATE.md`
- `features/add-int-e2e-harness/REFACTOR_NOTES.md`
- (If present) `features/add-int-e2e-harness/DESIGN_GUIDE.md`
