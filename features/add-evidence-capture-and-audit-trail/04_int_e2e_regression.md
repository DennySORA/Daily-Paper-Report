...
## Required Files
- `features/add-evidence-capture-and-audit-trail/E2E_PLAN.md`
- `features/add-evidence-capture-and-audit-trail/ACCEPTANCE.md`
- `features/add-evidence-capture-and-audit-trail/STATE.md`
- `features/add-evidence-capture-and-audit-trail/REFACTOR_NOTES.md`
- (If present) `features/add-evidence-capture-and-audit-trail/DESIGN_GUIDE.md`
