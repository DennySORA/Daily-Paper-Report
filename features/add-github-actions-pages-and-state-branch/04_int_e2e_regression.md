...
## Required Files
- `features/add-github-actions-pages-and-state-branch/E2E_PLAN.md`
...
- `features/add-github-actions-pages-and-state-branch/REFACTOR_NOTES.md`
- (If present) `features/add-github-actions-pages-and-state-branch/DESIGN_GUIDE.md`
