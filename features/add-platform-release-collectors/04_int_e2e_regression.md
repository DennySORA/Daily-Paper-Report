...
## Required Files
- `features/add-platform-release-collectors/E2E_PLAN.md`
- `features/add-platform-release-collectors/ACCEPTANCE.md`
- `features/add-platform-release-collectors/STATE.md`
- `features/add-platform-release-collectors/REFACTOR_NOTES.md`
- (If present) `features/add-platform-release-collectors/DESIGN_GUIDE.md`
