...
## Required Files
- `features/add-static-html-renderer/E2E_PLAN.md`
- `features/add-static-html-renderer/ACCEPTANCE.md`
- `features/add-static-html-renderer/STATE.md`
- `features/add-static-html-renderer/REFACTOR_NOTES.md`
- (If present) `features/add-static-html-renderer/DESIGN_GUIDE.md`
