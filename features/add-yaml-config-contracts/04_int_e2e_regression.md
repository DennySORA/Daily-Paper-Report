...
## Required Files
- `features/add-yaml-config-contracts/E2E_PLAN.md`
- `features/add-yaml-config-contracts/ACCEPTANCE.md`
- `features/add-yaml-config-contracts/STATE.md`
- `features/add-yaml-config-contracts/REFACTOR_NOTES.md`
- (If present) `features/add-yaml-config-contracts/DESIGN_GUIDE.md`
